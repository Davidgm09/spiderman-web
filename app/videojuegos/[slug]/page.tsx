          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href={game.amazonAsin ? `https://www.amazon.es/dp/${game.amazonAsin}?tag=${AMAZON_TAG}` : generateAmazonUrl(`${game.title} ${platformFirst} videojuego`)}
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              <SidebarAd />
              <AmazonProductCard
                title={`${game.title} — ${platformFirst}`}
                image={game.image}
                href={game.amazonAsin ? `https://www.amazon.es/dp/${game.amazonAsin}?tag=${AMAZON_TAG}` : generateAmazonUrl(`${game.title} ${platformFirst} videojuego`)}
                badge={platformFirst}
